...
export default function Hero({ sectionRefs, index }) {
  return (
    <div ref={sectionRefs.current[index]} id="hero" className="hero-background bg-center bg-fixed bg-no-repeat bg-cover h-screen relative">
      <div className="relative h-screen bg-opacity-50 bg-black" style={{ background: 'rgba(0,0,0,0.5)' }}>
